...
/**
 * Champs Carbon Fields — taxonomie Destination (pays).
 *
 * @package Travel_Dams
 */
...
Container::make('term_meta', __('Détails pays', 'travel-dams'))
    ...
    ->add_fields(array(
        ...
        Field::make('rich_text', 'country_description', __('Description du pays', 'travel-dams')),
